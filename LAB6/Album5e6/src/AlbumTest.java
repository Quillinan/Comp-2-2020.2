...
public class AlbumTest {
    ...
    @Test
    public void testarInstanciasEspecificas(){
        Album<Figurinha> novoAlbumFigurinhas = new Album<>(repositorioFigurinhas,5);
        //Nao funciona como o esperado:
        //Album<Selo> novoAlbumSelos = new Album<>(repositorioFigurinhas,5);
        Repositorio<Selo> repositorioSelos = new Repositorio<>("Selos Paises",500);
        Album<Selo> novoAlbumSelos = new Album<>(repositorioSelos,10);
        Pacotinho<Figurinha> pacotinhoFigurinha = new Pacotinho<>(repositorioFigurinhas,5);
        Pacotinho<Selo> pacotinhoSelo = new Pacotinho<>(repositorioSelos,10);
        //novoAlbumFigurinhas.receberNovoPacotinho(pacotinhoSelo);
        novoAlbumFigurinhas.receberNovoPacotinho(pacotinhoFigurinha);
        novoAlbumSelos.receberNovoPacotinho(pacotinhoSelo);
        assertEquals(TAMANHO_DO_ALBUM-5, novoAlbumFigurinhas.getQuantItensFaltantes());
        assertEquals(500-10,novoAlbumSelos.getQuantItensFaltantes());
    }
